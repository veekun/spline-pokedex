...
% for nature in c.natures:
    <tr>
        ...
        <td class="flavor">
            ...
            ${h.pokedex.pokedex_img("chrome/contest/{0}.png".format(nature.likes_flavor.identifier), alt=nature.likes_flavor.name)}
        </td>
        <td class="flavor">
            ${nature.hates_flavor.flavor}:
            ${h.pokedex.pokedex_img("chrome/contest/{0}.png".format(nature.hates_flavor.identifier), alt=nature.hates_flavor.name)}
        </td>
        % endif
    </tr>
% endfor
